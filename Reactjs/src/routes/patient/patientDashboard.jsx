        ...
        <div className="flex">
            ...
            <div className="w-64 bg-gray-800 text-white min-h-screen">
                <div className="p-4">
                    ...
                    <div className="mt-4">
                        <img
                            src={patient.profilePhoto ? `http://localhost:8080/uploads/${patient.profilePhoto}` : 'patientPhoto'}
                            alt="Profile"
                ...
                <nav className="mt-10">
                    ...
                    <Link to="/forgotPatientPassword" className="block py-2 px-4 hover:bg-gray-700">Forget Password</Link>
                    <span
