    ...
    <div className="flex">
      ...
      <div className="w-64 bg-gray-800 text-white min-h-screen">
        <div className="p-4">
          ...
          <div className="mt-4">
            {/* console.log("Doctor profile", {doctor.profilePhoto});             */}
            <img src={doctor.profilePhoto ? `http://localhost:8080/uploads/${doctor.profilePhoto}` : 'DoctorProfile'} alt="Profile" className="rounded-full w-20 h-20" />
            {/* <p className="mt-2 text-lg">{doctor.fullName || 'Dr. John Doe'}</p> */}
            {/* <p className="text-sm">{doctor.phone || '+1 234 567 8901'}</p> */}
          </div>
        </div>
        <nav className="mt-10">
          <a href="/" className="block py-2 px-4 hover:bg-gray-700"><Link to="/appointment" > Appointments </Link></a>
          <a href="/" className="block py-2 px-4 hover:bg-gray-700"><Link to="/myProfile" > My Profile </Link></a>
          <a href="/" className="block py-2 px-4 hover:bg-gray-700"><Link to="/changePassword" > Change Password </Link></a>
          <a href="/" className="block py-2 px-4 hover:bg-gray-700"><Link to="/forgetPassword" > Forget Password</Link></a>
          <a href="/" className="block py-2 px-4 hover:bg-gray-700" onClick={logout}>Logout</a>
        </nav>
      </div>
