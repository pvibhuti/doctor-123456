...
const MyProfile = () => {
  ...
  const handleFileUpload = async (e) => {
    ...
    try {
      ...
      const decryption = await decryptionProcess(response);
      console.log('Decryption Profile', decryption);
    ...
    <div className="min-h-screen flex justify-center items-center bg-gray-50">
      <div className="w-full max-w-md p-6 bg-white rounded-lg shadow-lg">
        ...
        <div className="flex flex-col items-center mb-6">
          <div className="w-24 h-24 mb-4">
            {profile.profilePhoto ? (
              <img
                src={profile.profilePhoto ? `http://localhost:8080/uploads/${profile.profilePhoto}` : 'DoctorProfile'}
                alt="Profile"
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <Link to="/doctorDashboard"> <button className="flex items-center space-x-2 px-5 py- text-sm text-white bg-blue-600 rounded-lg hover:bg-blue-700">
