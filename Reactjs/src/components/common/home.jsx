                    ...
                    <div className="hidden md:block w-full md:w-auto" id="menu">
                        <nav
                            ...
                            <ul className="md:flex items-center">
                                ...
                                <li className="md:ml-4"><a className="py-2 inline-block md:text-white md:px-2 font-semibold"
                                    href="/register"><Link to="/register" > Signup </Link></a></li>
                                <li className="md:ml-6 mt-3 md:mt-0">
                                    <a className="inline-block font-semibold px-4 py-2 text-white bg-blue-600 md:bg-transparent md:text-white border border-white rounded"
                                        href="/login" > <Link to="/login" >Log in</Link></a>
                                </li>
                            </ul>
                        </nav>
                    </div>
      ...
      items-center min-h-screen">
                    ...
                    <div class="lg:w-3/4 xl:w-2/4 relative z-10 h-100 lg:mt-16">
                        <div>
                            <h1 class="text-white text-4xl md:text-5xl xl:text-6xl font-bold leading-tight">A better life starts with a
                                healthy
                                Life.</h1>
                            <p class="text-blue-100 text-xl md:text-2xl leading-snug mt-4">Welcome to the our Hospital.</p>
                            <a href="/" class="px-8 py-4 bg-teal-500 text-white rounded inline-block mt-8 font-semibold"> <Link to="/login" >Book
                                Appointment </Link></a>
                        </div>
                    </div>
                </section>
            ...
            <section class="relative bg-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-32">
                <div class="">
                    ...
                    <p class="text-gray-600 mt-2 md:max-w-lg">Pellentesque habitant morbi tristique senectus et netus et malesuada
                        fames ac
                        turpis egestas.</p>
            ...
            {/* <section
                ...
                <div class="md:flex md:items-center md:justify-center">
                    <h2 class="text-xl font-bold text-white">Get in touch with us today! Call us on: +1
                        562-789-1935</h2>
                    <a href="/" class="px-8 py-4 bg-white text-blue-600 rounded inline-block font-semibold md:ml-8 mt-4 md:mt-0">Book
                        Appointment</a>
                </div>
            </section> */}
            {/* <!-- end cta --> */}
            ...
            <footer class="relative bg-gray-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-24">
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
                        ...
                        <p class="text-sm text-gray-400 mt-12">© 2018 ProDentists. Rights Reserved.
                        </p>
                    </div>
                </div>
            </footer>
